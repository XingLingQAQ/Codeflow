...
status: Historical
migrated: 2026-07-13 (M0.6) from plan/2026-02-05_23-05-58-tauri-go-desktop-app.md
---

# Plan: Tauri + Go 后端桌面应用方案

> **Historical**：M0.6 自根目录 `plan/` 迁入。桌面主线现行入口见  
> `docs/frontend-mainline-decision.md`（`apps/workbench`）。
