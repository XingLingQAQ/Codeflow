...
| G16 | `internal/workspace` | ⚠️ | list/read/stat/write + 沙箱 + **stage/promote/promote-all/discard/discard-all** + staged read；无 watch/WS | watch + project root 绑定 | M3 | 2026-07-15 |
