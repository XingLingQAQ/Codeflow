...
export class PlanCommands extends EventEmitter {
    ...
    async execute(commandName, params) {
        ...
        try {
            ...
            switch (commandName) {
                case 'plan-new':
                    result = await this.executePlanNew(params);
                    break;
                case 'plan-vision':
                    result = await this.executePlanVision(params);
                    break;
                case 'plan-constraints':
                    result = await this.executePlanConstraints(params);
                    break;
                case 'plan-ff':
                    result = await this.executePlanFastForward(params);
                    break;
                case 'plan-execute':
                    result = await this.executePlanExecute(params);
                    break;
                default:
                    result = {
                        success: false,
     ...
     * 执行 plan-vision 命令
     */
    async executePlanVision(params) {
        const visionData = {
     ...
     */
    async executePlanConstraints(params) {
     ...
     * 执行 plan-ff 命令
     */
    async executePlanFastForward(params) {
        const artifacts = {
            planId: params.planId,
     ...
     * 执行 plan-execute 命令
     */
    async executePlanExecute(params) {
        const executionData = {
            planId: params.planId,
...
//# sourceMappingURL=PlanCommands.js.map