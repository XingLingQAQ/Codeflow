 ...
 * 验证 Hook 触发顺序和并发场景
 */
import { HookManager, HookEvent } from './hooks/index.js';
async function main() {
    ...
    const chunk1 = { delta: 'Hello', index: 0, done: false };
    const chunk2 = { delta: ' ', index: 1, done: false };
    const chunk3 = { delta: 'World', index: 2, done: true };
