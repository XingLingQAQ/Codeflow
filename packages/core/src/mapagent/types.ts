...
export interface ExtractionResult {
  ...
  decisions: Array<{ content: string; importance: number; context?: string }>;
...
export interface IMapStorage {
  ...
  list(): Promise<Array<{ id: string; sessionId: string; createdAt: number }>>;
}

/**
 * 默认 Map Agent 配置
 */
export const DEFAULT_MAP_AGENT_CONFIG: MapAgentConfig = {
