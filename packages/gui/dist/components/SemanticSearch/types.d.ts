 ...
 * 搜索类型配置
 */
export declare const SEARCH_TYPE_CONFIG: Record<SearchType, {
    label: string;
    icon: string;
    color: string;
}>;
 ...
 * 来源颜色映射
 */
export declare const SOURCE_COLORS: Record<SearchSource, string>;
/**
 * 排序选项
 */
export declare const SEARCH_SORT_OPTIONS: Array<{
