...
export const CustomSelect = ({ options, value, onChange, placeholder = 'Select...', disabled = false, loading = false, searchable = false, clearable = false, size = 'md', variant = 'default', error = false, helperText, label, className, style, dropdownStyle, renderOption, renderValue, }) => {
    ...
    return (_jsxs("div", { ref: containerRef, className: className, style: { position: 'relative', display: 'inline-block', ...style }, children: [label && (_jsx("label", { style: {
                ...
                }, children: label })), _jsxs("div", { onClick: () => !disabled && setIsOpen(!isOpen), onKeyDown: handleKeyDown, tabIndex: disabled ? -1 : 0, style: getVariantStyles(), role: "combobox", "aria-expanded": isOpen, "aria-haspopup": "listbox", children: [loading ? (_jsx("span", { style: { color: colors.slate[400] }, children: "Loading..." })) : selectedOption ? (renderValue ? (renderValue(selectedOption)) : (_jsxs(_Fragment, { children: [selectedOption.icon && (_jsx("span", { style: { display: 'flex', alignItems: 'center' }, children: selectedOption.icon })), _jsx("span", { style: { flex: 1 }, children: selectedOption.label }), selectedOption.color && (_jsx("span", { style: {
                                    width: 8,
                                    height: 8,
                                    borderRadius: '50%',
                                    backgroundColor: selectedOption.color,
                                } }))] }))) : (_jsx("span", { style: { color: colors.slate[400], flex: 1 }, children: placeholder })), clearable && selectedOption && !disabled && (_jsx("button", { onClick: handleClear, style: {
                            display: 'flex',
                            alignItems: 'center',
                    ...
                    ...dropdownStyle,
                                ...
                                outline: 'none',
                            } }) })), _jsx("div", { style: { maxHeight: 280, overflowY: 'auto' }, children: filteredOptions.length === 0 ? (_jsx("div", { style: {
                                padding: spacing[4],
                                textAlign: 'center',
                                color: colors.slate[400],
                                fontSize: fontSize.sm,
                            }, children: "No options found" })) : (filteredOptions.map((opt, index) => {
                            ...
                            return (_jsxs("div", { onClick: () => handleSelect(opt), onMouseEnter: () => setHighlightedIndex(index), style: {
                                    ...
                                    transition: transitions.fast,
                                }, role: "option", "aria-selected": isSelected, children: [opt.icon && (_jsx("span", { style: {
                                            display: 'flex',
                                            alignItems: 'center',
                                            justifyContent: 'center',
                                            width: 24,
                                            ...
                                            color: opt.color || colors.slate[600],
                                                    ...
                                                    whiteSpace: 'nowrap',
                                                }, children: opt.description }))] }), isSelected && (_jsx("span", { style: { color: colors.primary[500], fontSize: 14 }, children: "\u2713" }))] }, opt.value));
                        })) })] })), _jsx("style", { children: `
        @keyframes slideDown {
          from {
            opacity: 0;
