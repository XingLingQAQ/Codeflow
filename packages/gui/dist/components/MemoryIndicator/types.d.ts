 ...
 * 级别颜色映射
 */
export declare const LEVEL_COLORS: Record<MatchLevel, string>;
/**
 * 级别边框颜色映射
 */
export declare const LEVEL_BORDER_COLORS: Record<MatchLevel, string>;
/**
 * 级别标签映射
 */
export declare const LEVEL_LABELS: Record<MatchLevel, string>;
/**
 * 根据分数计算匹配级别
 */
export declare function scoreToLevel(score: number): MatchLevel;
