...
const required = [
  ...
  ["POST", "/api/v1/workspace/watch"],
  ["DELETE", "/api/v1/workspace/watch"],
  ["GET", "/api/v1/workspace/watches"],
  ["POST", "/api/v1/skills"],
  ["GET", "/api/v1/skills"],
  ...
  ["POST", "/api/v1/agents/registry/{id}/usage"],
  ["POST", "/api/v1/agents/registry/{id}/score"],
  ...
  ["POST", "/api/v1/guard/exemption-requests"],
  ["GET", "/api/v1/guard/exemption-requests"],
  ["POST", "/api/v1/guard/exemption-requests/{id}/decide"],
  ["GET", "/api/v1/workspace/scripts"],
  ["GET", "/api/v1/workspace/dev-servers"],
  ["POST", "/api/v1/workspace/dev-servers"],
  ["DELETE", "/api/v1/workspace/dev-servers"],
  ["GET", "/api/v1/workspace/dev-servers/{id}/logs"],
