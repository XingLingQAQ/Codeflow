...
export const MOCK_TEMPLATES: FlowTemplateInfo[] = [
  {
    ...
    source: 'builtin',
    stages: [
      { type: 'idea', name: '意图', canvas: 'intent', optional: false },
      { type: 'design', name: '设计', canvas: 'design_doc', optional: false },
      { type: 'planning', name: '规划', canvas: 'planning_board', optional: false },
      { type: 'research', name: '调研', canvas: 'deep_search', optional: true },
      { type: 'coding', name: '编码', canvas: 'coding', optional: false },
      { type: 'review', name: '评审', canvas: 'review', optional: false },
      { type: 'submit', name: '提交', canvas: 'submit', optional: false },
    ],
  },
  {
    id: 'import_project',
    ...
    source: 'builtin',
    stages: [
      { type: 'import', name: '导入', canvas: 'import_pipeline', optional: false },
      { type: 'comprehension', name: '理解', canvas: 'comprehension', optional: false },
      { type: 'coding', name: '编码', canvas: 'coding', optional: false },
      { type: 'review', name: '评审', canvas: 'review', optional: false },
      { type: 'submit', name: '提交', canvas: 'submit', optional: false },
    ],
